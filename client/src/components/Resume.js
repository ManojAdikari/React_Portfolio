            ...
            <div className="row">
                <div className="col-12">
                    <div className="info-book">
                        ...
                        <a href="https://docs.google.com/document/d/1ZZvnRJOo-vOrAwvU0rlj1YT0z-HCRyuK/edit?usp=sharing&ouid=106094290608935730038&rtpof=true&sd=true" className="btn btn-outline-info btn-lg " target="_blank"> My
                            Resume</a>
